...
export function CallToAction({
  ...
  description = "Оставьте заявку, и наш менеджер свяжется с вами в течение 15 минут для обсуждения деталей.",
  features = [
    "Бесплатная консультация эксперта",
    "Технический анализ старого сайта",
    "Разработка стратегии продвижения",
    "Подбор оптимального стека технологий",
  ],
}: CallToActionProps) {
  return (
    <SectionContainer id="cta" className="scroll-mt-20">
